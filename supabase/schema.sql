...
CREATE TABLE organization_branding (
  ...
  logo_url TEXT,
  favicon_url TEXT,
  meeting_background_color TEXT DEFAULT '#000000',
  meeting_border_style TEXT DEFAULT 'subtle' CHECK (meeting_border_style IN ('none', 'subtle', 'bold')),
  show_logo_on_tiles BOOLEAN DEFAULT false,
